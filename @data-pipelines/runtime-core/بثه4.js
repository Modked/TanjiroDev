...
const handler = async (m, { conn }) => {
  try {
    ...
    exec(`ffmpeg -re -i https://dwamdstream103.akamaized.net/hls/live/2015526/dwstream103/index.m3u8 -c:v libx264 -c:a aac -f flv rtmps://live-api-s.facebook.com:443/rtmp/FB-1216500886605133-0-Ab2JckKQWQphiI6DBmwG8R4R`);
